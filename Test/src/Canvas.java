...
public class Canvas extends JPanel {
	...
	public Canvas() {
		...
		//iniate the mpanel w/ a sierpinski tetrahedron of depth 2
		fractal = new SierpinskiPolyhedra(new Tetrahedron(),2);
		faces = fractal.getFaces();
		
		//instantiate an arraiylist of visible faces 
	...
	/*
	 * returns a path2d shape of a particular face based on a set of coordiantes 
	 */
	...
	public void change(String text, int depth) {
		...
		//amount the shape will rotate per click 
